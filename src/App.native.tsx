...
const APP_URL = "https://ais-pre-3gtgasrhm73uz2kmyh3fun-254742075371.asia-southeast1.run.app?platform=mobile";
      ...
      <View style={styles.content}>
        ...
        {error && (
          <View style={styles.errorOverlay}>
            ...
            <Text style={styles.errorText}>Unable to connect to portal server. Please check your internet connection.</Text>
